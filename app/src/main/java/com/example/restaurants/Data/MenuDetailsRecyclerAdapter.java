...
public class MenuDetailsRecyclerAdapter extends RecyclerView.Adapter<MenuDetailsRecyclerAdapter.ViewHolder>{
    private Context context;
    private List<Menu_Items> menu_items;


    public MenuDetailsRecyclerAdapter(Context context, List<Menu_Items> menu_items) {
